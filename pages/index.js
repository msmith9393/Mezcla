            ...
            <div>
                <div className="container">
                    ...
                    <div>
                        ...
                        <p>
                            I love cooking and I love Spanish, so I decided to create this site to showcase my development skills and delicious recipes in English and Spanish. <Link href="/spanish"><a className="link">Click Here to change to Spanish.</a></Link> Also, feel free to checkout my <a className="link" href="https://youtube.com" target="_blank" rel="noreferrer">YouTube Channel</a> and <a className="link" href="https://instagram.com" target="_blank" rel="noreferrer">Instagram!</a>
                        </p>
                    </div>
                </div>
                ...
                <div className="center">
                    ...
                    <p><a className="link" href="https://github.com" target="_blank" rel="noreferrer">Checkout the Repo!</a></p>
                </div>
                <div className="line-break" />
                <div className="center">
                    <h2 className="headingLg center">I&apos;m looking for a job!</h2>
                    <p>Please to reach out to me by <a className="link" href="https://linkedin.com" target="_blank" rel="noreferrer">LinkedIn</a> or <a className="link" href="https://email.com">Email.</a></p>
                    <button type="button" className="button button-center">Resume</button>
                </div>
                <style jsx>{`
                    .container {
                        display: flex;
